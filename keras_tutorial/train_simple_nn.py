...
from keras.layers import Conv2D, MaxPool2D, GlobalMaxPool2D, Dropout, Flatten
...
print(classification_report(testY.argmax(axis=1),
                            predictions.argmax(axis=1), target_names=['waste', 'memory']))
...
model.save(m)
f = open(l_b, "wb")
f.write(pickle.dumps(['waste', 'memory']))
f.close()
